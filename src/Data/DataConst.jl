...
const CLS_db = Dict(
    ...
    "J250" => Dict("L"=>64, "beta"=>3.55, "kappa_l"=>0.1372067, "kappa_s"=>0.136546844, "dtr"=>1, "plat_t0"=>[30,170], "bc"=>"pbc"),
    "E250" => Dict("L"=>96, "beta"=>3.55, "kappa_l"=>0.137232867, "kappa_s"=>0.136536633, "dtr"=>1, "plat_t0"=>[25,170], "bc"=>"pbc"),
    
    "J307" => Dict("L"=>64, "beta"=>3.7, "kappa_l"=>0.137000, "kappa_s"=>0.137000, "dtr"=>2, "plat_t0"=>[25,170], "bc"=>"obc"),
    "N300" => Dict("L"=>48, "beta"=>3.7, "kappa_l"=>0.137000, "kappa_s"=>0.137000, "dtr"=>1, "plat_t0"=>[20,105], "bc"=>"obc"),
    "J306" => Dict("L"=>64, "beta"=>3.7, "kappa_l"=>0.137064, "kappa_s"=>0.1368721791358, "dtr"=>2, "plat_t0"=>[25,170], "bc"=>"obc"),
    ...
    "J501" => Dict("L"=>64, "beta"=>3.85, "kappa_l"=>0.1369032, "kappa_s"=>0.136749715, "dtr"=>1, "plat_t0"=>[42,160], "bc"=>"obc")
...
const CLS_CNFG = Dict(
    ...
    "J250" => Dict("repLen" => OrderedDict("r0" => 903, "r1" => 773, "r2" => 445), "nms" => 2121),
    "E250" => Dict("repLen" => OrderedDict("r0" => 151, "r1" => 1009), "nms" => 1160),

    # "J307" => Dict("repLen" => OrderedDict("r0" => 586, "r1" => 536), "nms" => 1122),   # used in deltaalpha
    # "J307" => Dict("repLen" => OrderedDict("r0" => 770, "r1" => 800), "nms" => 1570),   # used in B-physics
    "J307" => Dict("repLen" => OrderedDict("r0" => 1000, "r1" => 1000), "nms" => 2000),   # used in tau
    "N300" => Dict("repLen" => OrderedDict("r1" => 507, "r2" => 1540), "nms" => 2047),
    # "J306" => Dict("repLen" => OrderedDict("r0" => 587, "r1" => 587), "nms" => 1174), # used in delta alpha
    # "J306" => Dict("repLen" => OrderedDict("r0" => 950, "r1" => 950), "nms" => 1900), # used B-physics
    "J306" => Dict("repLen" => OrderedDict("r0" => 1000, "r1" => 1000), "nms" => 2000), # used in tau
    ...
    # "F300" => Dict("repLen" => OrderedDict("r0" => 105, "r1" => 398),      "nms" => 503), # used in delta alpha
    "F300" => Dict("repLen" => OrderedDict("r0" => 105, "r1" => 570, "r2"=> 200),      "nms" => 875), # 
